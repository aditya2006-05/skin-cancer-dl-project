...
const classData = {
  labels: ['Melanocytic Nevi (NV)', 'Melanoma (MEL)', 'Benign Keratosis (BKL)', 'Basal Cell Carcinoma (BCC)', 'Actinic Keratoses (AKIEC)', 'Vascular Lesions (VASC)', 'Dermatofibroma (DF)'],
  datasets: [{
...
new Chart(accuracyCtx, {
  type: 'bar',
  data: {
    labels: ['NV (Nevi)', 'MEL (Melanoma)', 'BKL (Keratosis)', 'BCC (Carcinoma)', 'AKIEC (Actinic)', 'VASC (Vascular)', 'DF (Fibroma)'],
    datasets: [{
      label: 'EfficientNet Accuracy (%)',
      data: [95, 87, 83, 81, 76, 72, 69],
      backgroundColor: [
...
console.log('%c🧬 SkinAI — Skin Cancer DL Project', 'color: #00e5c8; font-size: 18px; font-weight: bold;');
console.log('%cDataset: HAM10000 | 10,015 images | 7 classes', 'color: #94a3b8; font-size: 12px;');
